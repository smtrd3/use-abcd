...
const STREETS = [
  ...
  "Birch Way", "Walnut Blvd", "Spruce Pl", "Willow Ter", "Ash St",
  "Cherry Ln", "Poplar Ave", "Hickory Dr", "Sycamore Rd", "Chestnut Ct",
  "Magnolia Way", "Dogwood Blvd", "Juniper Pl", "Cypress Ter",
];
const CITIES = [
  "Springfield", "Riverside", "Fairview", "Madison", "Georgetown",
  "Clinton", "Arlington", "Salem", "Franklin", "Chester",
  "Burlington", "Oakland", "Greenville", "Bristol", "Newport",
];
const STATES = [
